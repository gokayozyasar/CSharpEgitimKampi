...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine();
            //Console.WriteLine();
            //Console.WriteLine("Alışverişinizin Toplam Tutarı : "+ shoppingTotalPrice+" TL'dir");
            ...
            //Console.WriteLine();
            //Console.WriteLine("---------------");
            //Console.WriteLine("Yolcu TC Kimlik Numarası  : "+passengerIdNumber + "- Yolcu Adı Soyadı"+ passengerName + " " + passengerSurname+ " "+ passengerDistrict+"/"+ passengerCity+"/" + passengerAge);
